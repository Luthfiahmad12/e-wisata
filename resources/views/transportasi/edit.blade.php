@extends('layouts.admin', ['title' => 'Edit data transportasi'])

@section('content')
    <div class="app-title">
        <div>
            <h1><i class="bi bi-speedometer ml-2"></i>Edit Transportasi</h1>
        </div>
        <a href="{{ route('transportasi.index') }}" class="btn btn-danger">
            Kembali
        </a>
    </div>
    ...
    <div class="mb-6">
        <div class="card">
            <form action="{{ route('transportasi.update', $transportasi) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Fasilitas Transportasi</label>
