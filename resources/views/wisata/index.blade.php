@extends('layouts.admin', ['title' => 'Daftar Wisata'])

@section('content-title')
    <div class="app-title">
        <div>
            <h1><i class="bi bi-speedometer ml-2"></i>Daftar Wisata</h1>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <a href="{{ route('wisata.edit', $item) }}" class="btn btn-warning">
                                    Edit
                                </a>
                                <form action="{{ route('wisata.destroy', $item) }}" method="post">
                                    @csrf
                                    @method('DELETE')
